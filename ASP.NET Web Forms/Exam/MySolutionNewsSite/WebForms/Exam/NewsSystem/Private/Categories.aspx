<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Categories.aspx.cs" Inherits="NewsSystem.Private.Categories" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ListView ID="ListViewCategory" runat="server"
        ...
        DeleteMethod="ListViewCategory_DeleteItem"
